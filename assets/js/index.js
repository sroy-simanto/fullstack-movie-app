...
fetchDataFormServer(`https://api.themoviedb.org/3/genre/movie/list?api_key=${api_key}`, function({genres}){
...
const heroBanner = function({ results: movieList }) {
    ...
    for(const [index, movie] of movieList.entries()) {
        ...
        controlItem.innerHTML = `
            <img src="${imageBaseURL}w154${poster_path}" alt="Slide to ${name}" loading="lazy" draggable="false" class="img-cover">
        `;
