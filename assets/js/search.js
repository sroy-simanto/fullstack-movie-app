...
export function search() {
    ...
    searchField.addEventListener("input", function() {
        ...
        searchTimeout = setTimeout(function() {
            fetchDataFormServer(`https://api.themoviedb.org/3/search/movie?api_key=${api_key}&query=${searchField.value}&include_adult=false&page=1`, function({results: movieList}) {
